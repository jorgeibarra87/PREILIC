...
<title>aprobar eventos buscar</title>
...
if($fila==1||$fil==1){
	echo"<center><p class=\"Estilo12\">APROBACION DE EVENTOS: </p></center><BR>";
...
LEFT JOIN `plico`.`solicitante` ON `eventos`.`id_solicitante` = `solicitante`.`id_solicitante` where`estado`='pendiente'";
echo"<center>";
echo"</center>";
...
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO QUE DESEA APROBAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/aprevento.php\">
  <label>NUM_RADICADO:
