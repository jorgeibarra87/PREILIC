...
echo"<center>";
echo"<center><p class=\"Estilo12\">ASIGNACION DE RECURSOS ELEGIR: </p></center><BR>";
$pager->Render($rows_per_page=10);
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO AL QUE LE DESEA ASIGNAR RECURSOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/asigrec.php\">
  <label>NUM_RADICADO:
