...
$consul=mysql_query("SELECT `permisos_perfil`.`id_perfil`,`permisos_perfil`.`id_permiso` FROM `permisos_perfil`where `permisos_perfil`.`id_perfil`='$perfil'and `permisos_perfil`.`id_permiso`='13'",$conexion);
...
echo"<center>";
echo"<center><p class=\"Estilo12\">ASIGNACION DE RESULTADOS ELEGIR: </p></center><BR>";
$pager->Render($rows_per_page=10);
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO AL QUE LE DESEA ASIGNAR RESULTADOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/asigres.php\">
  <label>NUM_RADICADO:
