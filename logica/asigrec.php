...
echo"<center>";
echo"<center><p class=\"Estilo12\">ASIGNAR RECURSOS: </p></center><BR>";
...
$rs=$base->dosql($sql);
echo"<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/asignacion.php?ID=$radicado\" onsubmit=\"return validar()\">
