...
<title>Buscar Evento Editar</title>
...
$consul=mysql_query("SELECT `permisos_perfil`.`id_perfil`,`permisos_perfil`.`id_permiso` FROM `permisos_perfil`where `permisos_perfil`.`id_perfil`='$perfil'and `permisos_perfil`.`id_permiso`='9'",$conexion);
$fil=mysql_num_rows($consul);
if($fila==1||$fil==1){
echo"<center><p class=\"Estilo12\">EDITAR EVENTOS: </p></center><BR>";
...
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO A EDITAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/edevento.php\">
  <label>NUM_RADICADO:
...
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO PARA VER DETALLES:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/verevento.php\">
  <label>NUM_RADICADO:
  <input type=\"text\" name=\"radicado\"/>
  </label>
  <label>
...
echo"</center><br><br>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO A BORRAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/borraeven.php\">
  <label>NUM_RADICADO:
  <input type=\"text\" name=\"radicado\"/>
  </label>
  <label>
