...
$sql="DELETE FROM `eventos` WHERE `num_radicado` =$ID";
...
$base->dosql($sql);
echo"<center><p class=\"Estilo12\">SI EL EVENTO ESTA RELACIONADO NO SE BORRARA DE LO CONTRARIO:</p></center><BR>";
echo"<center><p class=\"Estilo12\">EL EVENTO SE A BORRADO</p></center><BR>";
