...
$sql="DELETE FROM `plico`.`perfil` WHERE `perfil`.`id_perfil`=$ID";
$base->dosql($sql);
...
<center><p class=\"Estilo12\">SI EL PERFIL ESTA RELACIONADO NO SE BORRARA DE LO CONTRARIO:</p></center><BR>";
echo"<center><p class=\"Estilo12\">EL PERFIL SE A BORRADO</p></center><BR>";
echo"<center><a href=\"../logica/editarperfil.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center>";
