...
<title>borrar solicitante</title>
...
$sql=@mysql_query("DELETE FROM `solicitante` WHERE `cedula`='$ID'",$conexion);
$s=@mysql_num_rows($sql);
if($s==0){

echo"<center><p class=\"Estilo12\">SI EL SOLICITANTE ESTA RELACIONADO NO SE BORRARA DE LO CONTRARIO:</p></center><BR>";
echo"<center><p class=\"Estilo12\">EL SOLICITANTE SE A BORRADO</p></center><BR>";
echo"<center><a href=\"../logica/edsolicitante.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center>";
}
else{
