...
echo"</center><br><br>";
$sqldos="SELECT `recursoasignado`.`id_recursoasignado`,`recurso`.`nombre_recurso`,`recursoasignado`.`cantidad`,`recursoasignado`.`valor` FROM recursoasignado
...
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/cambiado.php?ID=$idevento\">
...
echo"<center><a href=\"../logica/cambiarestado.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}	
