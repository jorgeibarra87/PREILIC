...
<title>Creando Perfil Permiso</title>
...
$sql="SELECT `permisos_perfil`.`id_permisoperfil`,`permisos_perfil`.`id_perfil`,`permisos_perfil`.`id_permiso` FROM permisos_perfil where `permisos_perfil`.`id_perfil`=$perfil and `permisos_perfil`.`id_permiso`=$permiso";

$sqls="INSERT INTO `permisos_perfil` (`id_permisoperfil`, `id_perfil`, `id_permiso`) VALUES (NULL, '$perfil', '$permiso');";
...
if($filas==1){
echo"<center><p class=\"Estilo12\">EL PERMISO PERFIL YA EXISTE</p></center><BR><BR>";
echo"<center><a href=\"../logica/crearpp.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center>";
}
else{
if($querys=mysql_query($sqls,$db)){
echo"<center><p class=\"Estilo12\">EL PERMISO SE A ASIGNADO</p></center><BR><BR>";
echo"<center><a href=\"../logica/crearpp.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center>";
}
}
echo"</div>
