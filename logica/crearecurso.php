...
$rs=$base->dosql($sql);
		echo"<center><p class=\"Estilo12\">CREAR RECURSO:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/newrecurso.php\" onsubmit=\"return validar()\">
  <table width=\"420\" border=\"1\">
    <tr>
      <td width=\"155\"><center><BR>NOMBRE DEL RECURSO:<BR><BR></center> </td>
      <td width=\"232\"><label>
        <input type=\"text\" name=\"nombrerecurso\" />
      </label></td>
    </tr>
	<tr>
