...
$sql="SELECT `id_lugar`, `lugar`, `tipo_lugar` FROM `lugar`";
$rs=$base->dosql($sql);
		echo"<center><p class=\"Estilo12\">CREAR LUGAR:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/newlugar.php\" onsubmit=\"return validar()\">
