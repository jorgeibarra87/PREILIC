...
$rs=$base->dosql($sql);
		echo"<center><p class=\"Estilo12\">CREAR PERFIL:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/newperfil.php\" onsubmit=\"return validar()\">
