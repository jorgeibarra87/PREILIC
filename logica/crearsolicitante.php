...
if($fila==1||$fil==1){
   ...
   echo"<center><p class=\"Estilo12\">CREAR SOLICITANTE:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/newsolicitante.php\" onsubmit=\"return Validar(this);\">
  <table width=\"420\" border=\"1\">
    ...
    <tr>
      ...
      <td><label>
        <input type=\"text\" name=\"telefono\"  onkeyUp=\"return ValNumero(this);\"/>
      </label></td>
    </tr>
	<tr>
	...
	<tr>
      ...
      <td><label>
        ...
        <option value=\"Junta de Feria\">Junta de Feria</option>
