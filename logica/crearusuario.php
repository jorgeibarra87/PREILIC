...
$rs=$base->dosql($sql);
		echo"<center><p class=\"Estilo12\">CREAR USUARIO:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/nuevouser.php\" onsubmit=\"return validar()\">
            ...
            while(!$rs->EOF)
{
		...
		echo"<option value=\"$iperfil\">$perfil</option>";
		$rs->MoveNext();
}		
echo"</tr>
    <tr>
