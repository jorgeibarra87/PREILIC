...
<title>ver asignacion de recursos</title>
...
if($fila==1||$fil==1){
	echo"<BR><BR><center><p class=\"Estilo12\">BORRAR RECURSOS ASIGNADOS ELEGIR: </p></center><BR>";
...
echo"<center>";
echo"<BR><BR><center>DIGITE EL NUMERO DE RADICADO DEL EVENTO PARA BORRAR RECURSOS ASIGNADOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/ediasig.php\">
  <label>NUM_RADICADO:
