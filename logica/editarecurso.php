...
echo"<center><p class=\"Estilo12\">EDITAR RECURSOS: </p></center>";
echo"<center><p class=\"Estilo12\">RECURSOS: </p></center>";
$db = NewADOConnection('mysql');
$db->Connect('localhost','root','','plico');
$sql="SELECT `recurso`.`id_recurso`,`recurso`.`nombre_recurso`,`recurso`.`tipo_recurso` FROM recurso";
echo"<center>";
echo"</center>";
...
echo"<center>DIGITE EL NUMERO DEL RECURSO QUE VA A EDITAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/edrec.php\">
  <label>ID_RECURSO:
  <input type=\"text\" name=\"recurso\" onkeyUp=\"return ValNumero(this);\"/>
  </label>
  <label>
...
echo"<center>DIGITE EL NUMERO DEL RECURSO QUE VA A BORRAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/borrarec.php\">
  <label>ID_RECURSO:
  <input type=\"text\" name=\"recurso\" onkeyUp=\"return ValNumero(this);\"/>
  </label>
  <label>
