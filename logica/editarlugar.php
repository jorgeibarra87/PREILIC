...
echo"<center><p class=\"Estilo12\">EDITAR LUGARES: </p></center>";
echo"<center><p class=\"Estilo12\">LUGARES: </p></center>";
$db = NewADOConnection('mysql');
$db->Connect('localhost','root','','plico');
$sql="SELECT `id_lugar`, `municipio`, `lugar` FROM `lugar`";
echo"<center>";
echo"</center>";
...
echo"<center>DIGITE EL NUMERO DEL LUGAR QUE VA A EDITAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/edlug.php\">
  <label>ID_LUGAR:
  <input type=\"text\" name=\"lugar\" onkeyUp=\"return ValNumero(this);\"/>
  </label>
  <label>
...
echo"<center>DIGITE EL NUMERO DEL LUGAR QUE VA A BORRAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/borralug.php\">
  <label>ID_LUGAR:
  <input type=\"text\" name=\"lugar\" onkeyUp=\"return ValNumero(this);\"/>
  </label>
  <label>
