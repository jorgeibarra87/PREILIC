...
echo"<center><p class=\"Estilo12\">PERFILES: </p></center>";
...
$sqls="SELECT `id_perfil`, `nom_perfil` FROM `perfil`";
$rss=$base->dosql($sqls);

$sqlss="SELECT `id_perfil`, `nom_perfil` FROM `perfil`";
$rsss=$base->dosql($sqlss);

echo"<center><p class=\"Estilo12\">EDITAR PERFILES ELEGIR: </p></center><BR><BR>";
echo"<center><p class=\"Estilo12\">PERFILES: </p></center><BR>";
echo"<center>ELIJA EL PERFIL PARA EDITAR:</center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/editaper.php\">";
echo"<center>";
echo"<select name=\"perfil\">";
            while(!$rss->EOF)
{
	    $perfil=$rss->fields['nom_perfil'];
		$iperfil=$rss->fields['id_perfil'];
...
echo"<center>ELIJA EL PERFIL PARA BORRAR:</center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/borraperfil.php\">";
echo"<center>";
echo"<select name=\"perfil\">";
            while(!$rsss->EOF)
{
	    $perfil=$rsss->fields['nom_perfil'];
		$iperfil=$rsss->fields['id_perfil'];
		echo"<option value=\"$iperfil\">$perfil</option><BR><BR>";
		$rsss->MoveNext();
}		
echo"</center>";
