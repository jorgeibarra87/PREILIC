...
if(document.form1.lugar.value.length==0&&document.form1.tipolugar.value.length==0){ 
alert("campos vacios"); 
return false; 
}
else if(document.form1.lugar.value.length==0){ 
alert("lugar vacio"); 
return false; 
}
else if(document.form1.tipolugar.value.length==0){ 
alert("tipo de lugar vacio"); 
return false; 
}
else{
return true;
...
$idlugar=$_POST['lugar'];
$sql=mysql_query("SELECT `id_lugar`, `municipio`, `lugar` FROM `lugar`where `id_lugar`=$idlugar",$conexion);
...
$lugar= $rows['lugar'];
   ...
   echo"<center><p class=\"Estilo12\">EDITAR LUGAR:</p></center><BR>";
   echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/updatelugar.php?ID=$idlugar\" onsubmit=\"return validar()\">
  <table width=\"420\" border=\"1\">
    <tr>
      <td width=\"155\"><center><BR>MUNICIPIO:<BR><BR></center> </td>
      <td width=\"232\"><label>
        <input type=\"text\" name=\"municipio\" value=\"$municipio\" />
      </label></td>
    </tr>
	<tr>
      <td width=\"155\"><center><BR>NOMBRE DEL LUGAR:<BR><BR></center> </td>
      <td width=\"232\"><label>
...
echo"<center><a href=\"../logica/editarlugar.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
}
else{
echo"<center><img src=\"../presentacion/Advertencia.gif\"/></center>";
