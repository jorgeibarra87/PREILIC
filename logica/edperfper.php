...
<title>borrar perfil permisos</title>
...
$rs=$base->dosql($sql);
echo"<center><p class=\"Estilo12\">BORRAR PERFIL PERMISO: </p></center><BR><BR>";
echo"<center><p class=\"Estilo12\">PERFILES: </p></center><BR>";
echo"<center>ELIJA EL PERFIL PARA BORRAR LOS PERMISOS:</center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/editarpp.php\">";
echo"<center>";
...
echo"</center>";
echo"<center><BR><input type=\"submit\" name=\"Submit\" value=\" IR \" /></center><BR><BR>";
