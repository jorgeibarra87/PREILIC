...
<title>editar solicitantes</title>
...
$consul=mysql_query("SELECT `permisos_perfil`.`id_perfil`,`permisos_perfil`.`id_permiso` FROM `permisos_perfil`where `permisos_perfil`.`id_perfil`='$perfil'and `permisos_perfil`.`id_permiso`='7'",$conexion);
$fil=mysql_num_rows($consul);
if($fila==1||$fil==1){
echo"<center><p class=\"Estilo12\">EDITAR SOLICITANTES: </p></center>";
echo"<center><p class=\"Estilo12\">SOLICITANTES: </p></center>";
$db = NewADOConnection('mysql');
$db->Connect('localhost','root','','plico');
$sql="SELECT `solicitante`.`cedula`,`solicitante`.`solicitante`,`solicitante`.`direccion`,`solicitante`.`telefono`,`solicitante`.`email`,`solicitante`.`tipo_solicitante` FROM solicitante";
echo"<center>";
echo"</center>";
...
echo"<center>DIGITE EL NUMERO DE CEDULA DEL SOLICITANTE QUE VA A EDITAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/esolicitante.php\">
  <label>CEDULA:
...
echo"<center>DIGITE EL NUMERO DE CEDULA DEL SOLICITANTE QUE VA A BORRAR:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/borrasol.php\">
  <label>CEDULA:
  <input type=\"text\" name=\"cedula\"/>
  </label>
  <label>
