...
$sql="INSERT INTO `plico`.`lugar` (`id_lugar`, `municipio`, `lugar`) VALUES (NULL, '$municipio', '$lugar');";
if($rs=$base->dosql($sql))
{
echo"<center>EL LUGAR SE A CREADO</center><BR>";
echo"<center><a href=\"../logica/crearlugar.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
else{
