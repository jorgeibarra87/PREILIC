...
$sql="INSERT INTO `plico`.`perfil` (`id_perfil`, `nom_perfil`) VALUES (NULL, '$perfil');";
if($rs=$base->dosql($sql))
{
echo"<center>EL PERFIL SE A CREADO</center><BR>";
echo"<center><a href=\"../logica/crearperfil.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
else{
