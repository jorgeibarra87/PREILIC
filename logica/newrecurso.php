...
$sql="INSERT INTO `plico`.`recurso` (`id_recurso`, `nombre_recurso`, `tipo_recurso`) VALUES (NULL, '$nombrerecurso', '$tiporecurso');";
if($rs=$base->dosql($sql))
{
echo"<center>EL RECURSO SE A CREADO</center><BR>";
echo"<center><a href=\"../logica/crearecurso.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
else{
