...
$sql="INSERT INTO `plico`.`usuarios` (`id_usuario`, `login`, `pass`, `id_perfil`, `funcionario`) VALUES (NULL, '$login', '$pass', '$perfil', '$funcionario');";
if($rs=$base->dosql($sql))
{
echo"<center>EL USUARIO SE A CREADO</center><BR>";
