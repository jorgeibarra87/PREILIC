...
$consulta="UPDATE  `eventos` SET  `id_usuario_res` =  '$iduser' WHERE `eventos`.`id_evento` ='$ID'";
$consul="UPDATE  `eventos` SET  `fecha_resultado` =  '$fecha' WHERE `eventos`.`id_evento` ='$ID'";
$cons="UPDATE  `eventos` SET  `estado` =  '$aprueba' WHERE `eventos`.`id_evento` ='$ID'";
$rs=$base->dosql($consulta);
$rs=$base->dosql($consul);
$rs=$base->dosql($cons);
echo"<center><p\">EL ESTADO DEL EVENTO SE A MODIFICADO</p></center><BR>";
