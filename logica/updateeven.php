...
$sql="UPDATE `eventos` SET `num_radicado`='$radicado',`nom_evento`='$nomeven',`fecha_inicio`='$fechaini',`fecha_fin`='$fechafin',`id_lugar`='$lugar',`id_solicitante`='$solicitante' WHERE   `eventos`.`num_radicado`='$id'";
if($rs=$base->dosql($sql))
{
echo"<center>EL EVENTO SE A ACTUALIZADO</center><BR>";
