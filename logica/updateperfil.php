...
$sql="UPDATE `perfil` SET `nom_perfil`= '$perfil' WHERE id_perfil='$ID'";
if($rs=$base->dosql($sql))
{
echo"<center>EL PERFIL SE A ACTUALIZADO</center><BR>";
echo"<center><a href=\"../logica/editarperfil.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
else{
echo"<center><img src=\"../presentacion/Advertencia.gif\"/></center>";
echo"<center>DATOS ERRONEOS:</center><BR>";
echo"<center><a href=\"../logica/editaperfil.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}		
