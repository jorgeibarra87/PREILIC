...
$tiporec=$_POST['tiporecurso'];
$ID=$_GET['ID'];

$base=new base('localhost','root','','plico');
$sql="UPDATE `recurso` SET `nombre_recurso`= '$recurso',`tipo_recurso`='$tiporec' WHERE id_recurso='$ID'";
if($rs=$base->dosql($sql))
{
echo"<center>EL RECURSO SE A ACTUALIZADO</center><BR>";
