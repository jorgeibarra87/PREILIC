...
<title>editando solicitante</title>
...
$tel=$_POST['telefono'];
$email=$_POST['email'];
$tiposol=$_POST['tiposolicitante'];



$base=new base('localhost','root','','plico');
$sql="UPDATE `solicitante` SET `cedula`='$cedula',`solicitante`='$solicitante',`direccion`='$dir',`telefono`='$tel',`email`='$email',`tipo_solicitante`='$tiposol' WHERE   `cedula`='$id'";
if($rs=$base->dosql($sql))
{
echo"<center>EL SOLICITANTE SE A ACTUALIZADO</center><BR>";
