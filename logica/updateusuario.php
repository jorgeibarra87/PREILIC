...
$sql="UPDATE `usuarios` SET `login`='$login',`pass`='$pass',`id_perfil`='$perfil',`funcionario`= '$funcionario' WHERE   `usuarios`.`id_usuario`='$id'";
if($rs=$base->dosql($sql))
{
echo"<center>EL USUARIO SE A ACTUALIZADO</center><BR>";
echo"<center><a href=\"../logica/crearusuario.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
else{
echo"<center><img src=\"../presentacion/Advertencia.gif\"/></center>";
echo"<center>DATOS ERRONEOS:</center><BR>";
echo"<center><a href=\"../logica/editarusuario.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}		

}
else{
echo"<center>!LOS PASSWORD NO COINCIDEN¡</center><BR>";
echo"<center><a href=\"../logica/editarusuario.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><BR><BR>";
}
