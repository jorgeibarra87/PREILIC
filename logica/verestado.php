...
<title>Eventos Por Estado</title>
...
$estado=$_POST['estado'];
echo"<br><center><p class=\"Estilo12\">EVENTOS CON ESTADO: $estado :</p></center><br>";
...
LEFT JOIN `plico`.`solicitante` ON `eventos`.`id_solicitante` = `solicitante`.`id_solicitante` where `estado`='$estado'";
echo"<center>";
echo"</center>";
