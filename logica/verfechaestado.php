...
<title>Eventos Por Fechas y Estado</title>
...
$estado=$_POST['estado'];
echo"<br><center><p class=\"Estilo12\">EVENTOS DESDE LA FECHA: $fechaini HASTA LA FECHA: $fechafin Y ESTADO: $estado :</p></center><br>";
...
LEFT JOIN `plico`.`solicitante` ON `eventos`.`id_solicitante` = `solicitante`.`id_solicitante` where `eventos`.`fecha_inicio`>='$fechaini' and `eventos`.`fecha_inicio`<='$fechafin' and `estado`='$estado'";
echo"<center>";
echo"</center>";
...
echo"</center><br><br>";
echo"<center><a href=\"../logica/principal.php\"><IMG  src=\"../presentacion/volver.jpg\" ></a></center><br><br>";
