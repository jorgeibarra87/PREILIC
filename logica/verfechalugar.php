...
<title>Eventos Por Fechas y Lugar</title>
...
$lugar=$_POST['lugar'];
echo"<br><center><p class=\"Estilo12\">EVENTOS DESDE LA FECHA: $fechaini HASTA LA FECHA: $fechafin Y LUGAR: $lugar :</p></center><br>";
...
LEFT JOIN `plico`.`solicitante` ON `eventos`.`id_solicitante` = `solicitante`.`id_solicitante` where `eventos`.`fecha_inicio`>='$fechaini' and `eventos`.`fecha_inicio`<='$fechafin' and `lugar`='$lugar'";
echo"<center>";
echo"</center>";
