...
<title>Eventos Por Municipio</title>
...
$lugar=$_POST['lugar'];
echo"<br><center><p class=\"Estilo12\">EVENTOS CON LUGAR: $lugar :</p></center><br>";
...
LEFT JOIN `plico`.`solicitante` ON `eventos`.`id_solicitante` = `solicitante`.`id_solicitante` where `lugar`='$lugar'";
echo"<center>";
echo"</center>";
