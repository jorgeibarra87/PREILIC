...
$consul=mysql_query("SELECT `permisos_perfil`.`id_perfil`,`permisos_perfil`.`id_permiso` FROM `permisos_perfil`where `permisos_perfil`.`id_perfil`='$perfil'and `permisos_perfil`.`id_permiso`='11'",$conexion);
$fil=mysql_num_rows($consul);
if($fila==1||$fil==1){
	echo"<center><p class=\"Estilo12\">VER RESULTADOS ASIGNADOS ELEGIR: </p></center><BR>";
...
echo"<center>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO PARA VER LOS RECURSOS ASIGNADOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../logica/verres.php\">
  <label>NUM_RADICADO:
