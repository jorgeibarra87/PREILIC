...
<title>comentario aprobacion</title>
...
$sql="UPDATE  `eventos` SET  `comentario_apr` =  '$com' WHERE `eventos`.`num_radicado` ='$ID'";
$rs=$base->dosql($sql);
echo"<center>SE A AGREGADO EL COMENTARIO</center><br>";
