...
$Tabla .= "<tr><td>REPORTE DE RECURSOS ASIGNADOS<br></td></tr>";
$Tabla .= "<tr><td>***********************************</td></tr>";
...
$Tabla .= "<table border=\"1\"><tr><td>***********************************</td></tr><br>";
$Tabla .= "<tr><td><b>RECURSOS ASIGNADOS</b><br></td></tr>";
$Tabla .= "<tr><td>***********************************</td></tr>";
...
header("Content-Disposition: attachment; filename=Reporte_Rec_Asignados_".date('d-m-Y').".xls");
echo $Tabla;
?>		
</body>
</html>
