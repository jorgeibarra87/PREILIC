...
echo"<center><p class=\"Estilo12\">REPORTES DE DATOS BASICOS:</p></center><BR>";
echo"<center><p\">REPORTE DE RECURSOS:</p></center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../presentacion/reporterec.php\">";
echo"<td><center><BR><input type=\"submit\" name=\"recursos\" value=\"GENERAR REPORTE\" /><BR><BR></center> </td>";
echo"</form></center><br><br>";

echo"<center><p\">REPORTE DE LUGARES:</p></center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../presentacion/reportelug.php\">";
echo"<td><center><BR><input type=\"submit\" name=\"lugares\" value=\"GENERAR REPORTE\" /><BR><BR></center> </td>";
echo"</form></center><br><br>";

echo"<center><p\">REPORTE DE SOLICITANTES:</p></center><BR>";
echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"../presentacion/reportesol.php\">";
echo"<td><center><BR><input type=\"submit\" name=\"solicitantes\" value=\"GENERAR REPORTE\" /><BR><BR></center> </td>";
echo"</form></center><br><br>";
