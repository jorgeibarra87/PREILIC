...
echo"<center><p class=\"Estilo12\">REPORTE RECURSOS ASIGNADOS ELEGIR: </p></center><BR>";
...
echo"<center>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO PARA GENERAR EL REPORTE DE RECURSOS ASIGNADOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../presentacion/repasig.php\">
  <label>NUM_RADICADO:
