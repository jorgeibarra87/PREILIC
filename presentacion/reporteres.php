...
<title>reporte recursos asignados</title>
...
echo"<center><p class=\"Estilo12\">REPORTE RESULTADOS ASIGNADOS ELEGIR: </p></center><BR>";
...
echo"<center>";
echo"<center>DIGITE EL NUMERO DE RADICADO DEL EVENTO PARA GENERAR EL REPORTE DE RESULTADOS ASIGNADOS:</center><BR>";
echo"</p><center>
<form id=\"form1\" name=\"form1\" method=\"post\" action=\"../presentacion/represasig.php\">
  <label>NUM_RADICADO:
