...
echo"<br><br><center><p class=\"Estilo12\">GENERACION DE REPORTES: </p></center><BR><br><br>";

echo"<center><form id=\"form2\" name=\"form2\" method=\"post\" action=\"../presentacion/redirigir.php\">
    <label>
      ...
      <select name=\"reporte\">
		...
		<option value=\"Reporte Resultados Asignados\">Reporte Resultados Asignados</option>
        <option value=\"Reporte Datos Basicos\">Reporte Datos Basicos</option>
      </select> 
    </label>
    <label>
